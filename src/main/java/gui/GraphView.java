...
public class GraphView implements SimulatorView {
     ...
     */
    public void showStatus(int step, game.Map map) {
        graph.update(step, map, stats);
    }
     ...
     */
    public boolean isViable(game.Map map) {
        return map.gameOver();
    }
    ...
    class GraphPanel extends JComponent {
         ...
         */
        public void update(int step, game.Map map, MapStats stats) {
            if (classes.size() >= 2) {
                ...
                stats.reset();
                int count1 = stats.getPopulationCount(map, class1);
                int count2 = stats.getPopulationCount(map, class2);
                int count3 = stats.getPopulationCount(map, class1);
                int count4 = stats.getPopulationCount(map, class2);
                ...
                countLabel.setText(stats.getPopulationDetails(map));
            }
        }
